...
bin <-   'geotop' ####'ge/home/ecor/local/geotop/GEOtop/bin/geotop-2.0.0' 
...
geotop.soil.param.file <- '/home/lv70864/ecordano/script/param/param_pso_test3.csv' #####home/ecor/Dropbox/R-packages/geotopOptim/inst/examples_2rd/param/param_pso_test3.csv' 
